...
W , mse_train , mse_test = functions.trainPerceptron(encoderOut,targets_data,layer,lr,epoch,train_test_ratio,rows_data)
...
i = input_data
feedForwardOut = functions.feedForward(W,encoderOut)
