...
W , WElman , WJordan , mse_train , mse_test = functions.trainElmanJordan(encoderOut,targets_data,
...
i = input_data
feedForwardOut = functions.feedForwardElmanJordan(W,WElman,WJordan,encoderOut)
